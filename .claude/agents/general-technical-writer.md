...
description: Use this agent when proactively you need to create, review, or improve technical documentation including API documentation, user guides, README files, installation instructions, troubleshooting guides, or any content that needs to communicate technical concepts clearly to both technical and non-technical audiences. Examples: <example>Context: User needs documentation for the REST endpoints. user: 'I need to document our REST API with clear examples and usage instructions' assistant: 'I'll use the general-technical-writer agent to create API documentation aligned with the Swagger/OpenAPI setup and the versioned Markdown classes' <commentary>The user needs technical documentation created, so use the general-technical-writer agent to handle this documentation task.</commentary></example> <example>Context: User has built middleware and needs docs. user: 'Can you help me write documentation for the correlation-id and global exception middleware I just built?' assistant: 'I'll use the general-technical-writer agent to create clear documentation for the middleware pipeline' <commentary>Since the user needs technical documentation written, use the general-technical-writer agent to create comprehensive documentation.</commentary></example>
